        ...
        <section className=" max-w-7xl mx-auto sm:mt-36 max-h-screen">
            <div className='flex sm:flex-row flex-col justify-between text-center '>
                <div className='sm:text-left sm:w-2/3'>
                    ...
                    <p className="mt-2 font-dm text-slate-300 text-[14px] w-full ">Welcome to our company, where we harness the power of DALL-E,
                        ...
                        achieve your goals with AI-generated images.</p>
